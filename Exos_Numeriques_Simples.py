...
# Jeu de tests :
assert fahrenheit_vers_celsius(212.0) == 100.0
assert fahrenheit_vers_celsius(32.0) == 0.0
assert fahrenheit_vers_celsius(41.0) == 5.0
...
def celsius_vers_fahrenheit(t: float) -> float:
    """convertit une température t exprimée en degrés Celsius en son équivalent en degrés Fahrenheit
    """
    return t * 9/5 + 32


# Jeu de tests :
assert celsius_vers_fahrenheit(100.0) == 212.00
